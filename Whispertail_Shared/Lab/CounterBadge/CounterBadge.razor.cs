...
public partial class CounterBadge : FluentComponentBase, IDisposable
{
	...
	protected override Task OnParametersSetAsync() {
		return (BackgroundColor is not null && Color is null) || (BackgroundColor is null && Color is not null)
			? throw new ArgumentException("Both BackgroundColor and Color must be set.")
			: BackgroundColor is Microsoft.Fast.Components.FluentUI.Color.Custom ||
			Color is Microsoft.Fast.Components.FluentUI.Color.Custom
			? throw new ArgumentException("Color.Custom is not supported.")
			: Appearance is not Microsoft.Fast.Components.FluentUI.Appearance.Accent and
			not Microsoft.Fast.Components.FluentUI.Appearance.Lightweight and
			not Microsoft.Fast.Components.FluentUI.Appearance.Neutral
	...
	private Color? GetBackgroundColor() {
		return BackgroundColor != null
			? BackgroundColor == Microsoft.Fast.Components.FluentUI.Color.Lightweight && GlobalState.Luminance == StandardLuminance.DarkMode
				? Microsoft.Fast.Components.FluentUI.Color.FillInverse
				: BackgroundColor == Microsoft.Fast.Components.FluentUI.Color.Lightweight && GlobalState.Luminance == StandardLuminance.LightMode
				? Microsoft.Fast.Components.FluentUI.Color.Lightweight
				: BackgroundColor
			: Appearance switch {
	...
	private Color? GetFontColor() {
		return Color != null
			? BackgroundColor == Microsoft.Fast.Components.FluentUI.Color.Error && GlobalState.Luminance == StandardLuminance.DarkMode
				? Microsoft.Fast.Components.FluentUI.Color.FillInverse
				: Color
			: Appearance switch {
